...
export const codeSchema = z.string().regex(/^[a-zA-Z0-9]{8}$/, {
	message: "コードは8文字の半角英数字で入力してください",
});
...
export class Company {
	...
	static create(params: CompanyParams): Company {
		Company.validate(params);
		return new Company(params.id, params.name, params.code);
	}
