...
import type {
	...
	UpdateUserResult,
	UserRepository,
} from "@/domain/core/User/repository/UserRepository";
...
import {
	...
	toMeetingMethodEnum,
	toStatusEnum,
} from "../Employee/toEntityEnumFunctions";
			...
			employee: user.employee
				? Employee.create({
						...
						workLocation: user.employee.workLocation
							...
							: undefined,
						hiringType: user.employee.hiringType
							? toHiringTypeEnum(user.employee.hiringType)
							: undefined,
						meetingMethod: user.employee.meetingMethod
							? toMeetingMethodEnum(user.employee.meetingMethod)
							: undefined,
