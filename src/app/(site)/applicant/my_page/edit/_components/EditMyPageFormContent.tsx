...
import { type UpdateApplicantForMyPageActionResult, updateApplicantForMyPageAction } from "../_actions/updateEmployeeForMyPageAction";
import { updateApplicantForMyPageSchema } from "../_schema/updateApplicantForMyPageSchema";

export const EditMyPageFormContent = ({ applicant, user, occupations }:
  { user: Session["user"], applicant: ApplicantDetailResponse, occupations: Occupation[] }) => {
  const [lastResult, action] = useFormState<UpdateApplicantForMyPageActionResult, FormData>(
    ...
    <form
        ...
        <div className="flex flex-col items-center shadow rounded-xl py-4 px-8">
          <div className="flex items-center gap-4">
            <Avatar.Root className="w-44 h-44 rounded-full">
              {applicant.imageUrl &&
                <Avatar.Image className="w-full h-full rounded-full" src={applicant.imageUrl} alt={applicant.name} />}
          ...
          <div className="w-full">
            ...
            <div className="my-5 flex flex-col items-start">
              ...
              <select name="occupation" className="ms-4 mt-2 border p-2 rounded" defaultValue={applicant.occupation ? applicant.occupation.id : ""}>
      ...
      <div className="col-span-8">
        ...
        <div className="mt-6 mb-14">
          ...
          <Textarea name="selfIntroduction" className="h-44" defaultValue={applicant.selfIntroduction} />
