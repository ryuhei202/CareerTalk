    ...
    <>
      <div className="grid grid-cols-12 gap-8 container mt-16 mx-auto mb-12">
          ...
          <div className="flex flex-col items-center shadow rounded-xl py-4 px-8  bg-gradient-to-r from-white to-blue-50">
            ...
            <div className="w-full">
              ...
              <div className="my-5 flex flex-col items-start">
                ...
                <span className="ms-4 mt-2">{applicant.data.company ? applicant.data.company : "入力がありません"}</span>
              </div>
              <div className="my-5 flex flex-col items-start">
              ...
              <div className="my-5 flex flex-col items-start">
                ...
                <div className="ms-4 mt-2" >{applicant.data.yearsOfExperience}年</div>
              </div>
        ...
        <div className="col-span-8">
          ...
          <div className="mt-6">
            <h2 className="text-gray-700 text-3xl font-bold mb-3 border-b pb-3">職務経歴</h2>
            <div className="mb-14 whitespace-pre-line">{applicant.data.workHistory}</div>
          </div>
          <div className="mt-6">
            <h2 className="text-gray-700 text-3xl font-bold mb-3 border-b pb-3">学歴</h2>
            <div className="mb-14 whitespace-pre-line">{applicant.data.education}</div>
          </div>
        </div >
      </div >
    </>
